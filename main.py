...
def get_args_parser():
    ...
    parser.add_argument('--actives_loss_coef', default=2, type=float)
...
def main(args):
    ...
    freeze = True
    # train_list = ['track_decoder', 'track_embed', 'class_embed', 'bbox_embed', 'position', 'yolox_embed', 'track_query', 'query_embed', 'refine_embed']
    train_list = ['track_decoder', 'track_query', 'track_embed', 'class_embed', 'bbox_embed']
    if freeze:
        # for params in model.backbone.parameters():
        #     params.requires_grad = False
        # for params in model.transformer.encoder.parameters():
        #     params.requires_grad = False
        ...
        for params in model.named_parameters():
            for layers in train_list:
                if layers in params[0] :
