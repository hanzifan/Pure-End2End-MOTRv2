...
class Detector(object):
    ...
    def detect(self, prob_threshold=0.6, area_threshold=100, vis=False):
        ...
        track_query = torch.nn.Embedding(300, 256)
        track_query = track_query.weight
        track_tgt = track_query.unsqueeze(0).repeat(1, 1, 1)
        for i, data in enumerate(tqdm(loader)):
            ...
            res = self.detr.inference_single_image(cur_img, (seq_h, seq_w), pre_img_emb, track_tgt, track_instances, proposals)
